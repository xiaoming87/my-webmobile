...
var mainApp = angular.module('mainApp', ['ui.router', 'firebase', 'ja.qr', 'qrScanner'])
...
.config(function($stateProvider, $urlRouterProvider) {
    $stateProvider
        ...
        .state('firebase', {
            ...
            controller: function($scope, $firebaseObject, $firebaseArray, $firebaseAuth) {
                ...
                // function
                $scope.addData = (newData) => $scope.firebaseDemo.$add(newData);
                
                $scope.facebookAuth = function() {
                    auth.$authWithOAuthPopup('facebook', {remember: 'default',scope: 'email,user_likes,user_friends'})
